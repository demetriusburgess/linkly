            ...
            <div class="row justify-content-center">
                <div class="content col-5">
                    <div class="hero-content text-center">
                        <p class="pill-heading fs-6 fw-bold text-uppercase _color--secondary-1 _bkgrd--secondary-102">Sign Up</p>
                        <h1 class="fs-1 fw-bold text-uppercase _color--tertiary-1">Create An Account</h1>
                    </div>
                    {{include('form-sign-up')}}
