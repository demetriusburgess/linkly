<?
    ...
    function get_hero(array $new_content, bool $short = false) {
        $default_content = [
            'title' => '',
            'subtitle' => '',
            'message' => '',
        ...
        $content = array_replace_recursive($default_content, $new_content);

        if (!$short) {
            require($ROOTPATH . 'hero.php');
            return;
        }

        require($ROOTPATH . 'hero-short.php');
    }
